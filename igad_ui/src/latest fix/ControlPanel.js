...
const ControlPanel = ({
  ...
  const handleApplyFilter = useCallback(
    ...
    [layerFilters, onApplyFilter, layerUrls, layersVisibility, toggleLayerVisibility]
  );
  ...
  const layerGroupsMonitoring = {
    ...
    DesertLocustPests: [
      { name: 'Desert Locust Band', icon: 'brown', geoserverName: 'Band Master' },
      { name: 'Desert Locust Swarms', icon: 'blue', geoserverName: 'Swarms' },
      { name: 'Desert Locust Hoppers', icon: 'green', geoserverName: 'Hoppers' },
    ],
    Precipitation: ['Monthly Precipitation (CHIRPS)'],
    SoilMoisture: ['Monthly Soil Moisture Anomaly'],
